...
import library.service.NewsletterSendService;
import library.service.NewsletterService;
...
| 273 | root | localhost:53294 | library | Sleep   |  365 |       | NULL             |
| 274 | root | localhost:53295 | library | Sleep   |  468 |       | NULL             |
| 275 | root | localhost:53296 | library | Sleep   |    1 |       | NULL             |
| 278 | root | localhost:53306 | library | Sleep   |  467 |       | NULL             |
| 279 | root | localhost:53305 | library | Sleep   |    7 |       | NULL             |
| 280 | root | localhost:53307 | library | Sleep   |  467 |       | NULL             |
+-----+------+-----------------+---------+---------+------+-------+------------------+
